...
from worker.clientScripts.assign_file_uuids import call
...
@mock.patch("worker.clientScripts.assign_file_uuids.find_mets_file")
@mock.patch("worker.clientScripts.assign_file_uuids.get_file_info_from_mets")
