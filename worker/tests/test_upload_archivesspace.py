...
from worker.clientScripts import upload_archivesspace
...
@mock.patch("worker.clientScripts.upload_archivesspace.logger")
...
@mock.patch(
    "worker.clientScripts.upload_archivesspace.ArchivesSpaceDIPObjectResourcePairing.objects.filter",
    return_value=[
...
@mock.patch("worker.clientScripts.upload_archivesspace.mets_file")
@mock.patch("worker.clientScripts.upload_archivesspace.get_pairs")
...
@mock.patch(
    "worker.clientScripts.upload_archivesspace.get_parser",
...
@mock.patch("worker.clientScripts.upload_archivesspace.ArchivesSpaceClient")
@mock.patch(
    "worker.clientScripts.upload_archivesspace.get_files_from_dip", return_value=[]
)
@mock.patch("worker.clientScripts.upload_archivesspace.upload_to_archivesspace")
def test_call(
...
@mock.patch("worker.clientScripts.upload_archivesspace.get_parser")
@mock.patch("worker.clientScripts.upload_archivesspace.ArchivesSpaceClient")
@mock.patch("worker.clientScripts.upload_archivesspace.get_files_from_dip")
@mock.patch("worker.clientScripts.upload_archivesspace.upload_to_archivesspace")
...
@mock.patch("worker.clientScripts.upload_archivesspace.get_files_from_dip")
@mock.patch(
    "worker.clientScripts.upload_archivesspace.upload_to_archivesspace",
    return_value=False,
)
