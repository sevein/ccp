...
from worker.clientScripts import email_fail_report
...
@mock.patch("worker.clientScripts.email_fail_report.get_emails_from_dashboard_users")
@mock.patch(
    "worker.clientScripts.email_fail_report.get_content_for", return_value="my report"
)
@mock.patch("worker.clientScripts.email_fail_report.send_email")
@mock.patch("worker.clientScripts.email_fail_report.store_report")
