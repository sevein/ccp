...
from worker.clientScripts.create_mets_v2 import createDMDIDsFromCSVMetadata
from worker.clientScripts.create_mets_v2 import main
from worker.main.models import DublinCore
from worker.main.models import File
from worker.main.models import MetadataAppliesToType
from worker.main.models import SIPArrange
from worker.utils.namespaces import NSMAP


@mock.patch(
    "worker.clientScripts.create_mets_v2.createDmdSecsFromCSVParsedMetadata",
    return_value=[],
)
...
@mock.patch(
    "worker.clientScripts.create_mets_v2.archivematicaCreateMETSMetadataXML.process_xml_metadata"
)
